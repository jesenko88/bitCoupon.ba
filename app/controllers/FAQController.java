...
public class FAQController extends Controller{
	...
	public static Result showFAQ(){
		try{
			...
			flash("error", "Error while rendering FAQ page.");
			Logger.error("Error at showFAQ: " +e.getMessage());
			return redirect("/");
		}
	}
	...
	public static Result editFAQView(int id){
		try{
			...
			flash("error", "Error occured while loading edit FAQ page."
					+ "Please check your logs.");
			Logger.error("Error at editFAQView: " +e.getMessage());
			return redirect("/");
		}
	}
	...
	public static Result deleteFAQ(int id){
		try{
			...
			flash("error", "Error occured while deleting FAQ. Please check your logs");
